  ...
  <div class="in-wrap">
    ...
    <header id="header">
      <section class="container">
        <h1 id="logo">
          <a href="#" title="左神学院">
            <img src="~/assets/img/logo.png" width="100%" alt="左神学院">
          </a>
        </h1>
        <div class="h-r-nsl">
          <ul class="nav">
      ...
      <section class="container">
        <div class>
          ...
          <ul class="of flink-list">
            <li>
              <a href="http://www.scut.com/" title="华工" target="_blank">华工</a>
            </li>
          </ul>
          <div class="clear"></div>
        </div>
          ...
          <section class="fl col-7">
            <section class="mr20">
              <section class="b-f-link">
                ...
                <span>Email：zixingli1821@gmail.com</span>
              </section>
              <section class="b-f-link mt10">
                <span>©2018课程版权均归左神学院所有 京ICP备17055252号</span>
              </section>
            </section>
          </section>
